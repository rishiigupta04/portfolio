...
const RecentProjects = () => {
  return (
    <div className="py-20" id="projects">
      ...
      <br />
      <p className="text-center md:tracking-wider mb-4 text-sm md:text-lg lg:text-2xl opacity-75 ">includes gen AI, data science, machine learning and web development projects</p>
      <div className="flex flex-wrap items-center justify-center p-4 gap-x-24 gap-y-8 mt-10">
        {projects.map(({ id, title, des, img, iconLists, link }) => (
          <div
            key={id}
            className=" sm:h-[41rem] h-[42rem] mt-12 lg:min-h-[32.5rem] flex items-center justify-center sm:w-[576px] w-[80vw]"
          >
